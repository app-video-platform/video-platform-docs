...
This page is for End Users and visitors who want to understand what the customer experience currently supports.

Visitors can browse product discovery pages and open Product Landing Pages. Signed-in End Users can also use customer navigation areas such as the cart and library.
...
The current customer journey starts with product discovery. Customers can browse the Explore page, search for products, open public creator Storefront pages, and open Product Landing Pages to review more information.
...
- [Product Landing Pages](./product-detail-pages.md)
