...
- Onboarding copy mentions analytics; current Creator Analytics reporting is backend-supported for Creator accounts, without Membership subscription analytics.
