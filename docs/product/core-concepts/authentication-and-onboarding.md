...
- Onboarding copy mentions analytics; current Creator Analytics has a frontend aggregate contract, but production-backed analytics reporting is not implemented yet.
