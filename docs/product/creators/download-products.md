...
- Add sections to organize files.
- Edit section titles and descriptions.
- Upload files inside a section.
...
Download files are added inside sections. A section needs a title before it can be created and used for file uploads.

Creators can edit section titles and descriptions after a section exists.

### Add files

Inside an existing Download section, use the file uploader to select files.

After a file is uploaded successfully, it appears in the section's uploaded files list with:
...
Use the Remove action on an uploaded file to delete it from the section.
