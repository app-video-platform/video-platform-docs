...
It is the main place to find existing products, filter the list, create a new product, and open a product for editing.
...
- See product cards with product title, type, price, and product image placeholder.
- Search products by title or description.
- Filter products by status.
- Filter products by product type.
- Filter products by free or paid pricing.
- Sort products by creation date, update date, or name.
- Start creating a new product.
- Open an existing product from the list.
...
Opening an existing product takes the creator to the product page or product editor depending on the available action. Existing products can be edited through the product builder.

## Current limitations

- Search, filtering, and sorting are applied to the products already loaded in the product list.
- Product cards currently use a placeholder image rather than reliably showing creator-uploaded product media.
