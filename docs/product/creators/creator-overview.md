...
Creators can create products, edit product details, organize product content, set pricing, and review their product list. The current creator workflow is centered on three supported product types:

- Course
- Download
- Consultation

Membership products are not currently supported.
...
- **Product-specific setup**: configure course content, download files, or consultation details depending on the selected product type.
