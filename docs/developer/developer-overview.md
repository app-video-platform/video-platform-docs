...
Use the `video-platform-ui` working tree as the implementation source of truth.

When product behavior is incomplete, document the user-facing limitation in Product Documentation and the technical details here only when they help maintain the frontend.
